...
class PlayerControllerRL(PlayerController, FishesModelling):
    ...
    def q_learning(self):
        ...
        while episode <= self.episode_max and diff > threshold:
            ...
            while not end_episode:
                ...
                # choose the highest Q value, discard nan values.
                ...
                Q[s_current][action] = Q_old[s_current][action] + lr * (R + discount * np.nanmax(Q_old[s_next])-Q[s_current][action])
                # ADD YOUR CODE SNIPPET BETWEEN EX. 2.2
